...
public class SessionInputFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		validActions.add("checkbalance");
		validActions.add("deposit");
		validActions.add("withdraw");
		validActions.add("receipt");
